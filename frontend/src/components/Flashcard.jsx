  ...
  return (
    <li>
      <label className="swap swap-flip text-9xl ">
        <input type="checkbox" />
        <div className="card items-center text-center swap-off bg-base-100 h-48 flex justify-center border border-primary">
        ...
        <div className="card items-center text-center swap-on bg-base-100 h-48 flex justify-center border border-primary overflow-auto">
